...
export default function UpdetProduct(props) {
  ...
  console.log(params.UpateProduct);
  async function getproduct(){
    try{
      await fetch(`${products_url}/${params.UpateProduct}`)
      .then((res)=>res.json())
...
try{
 ...
 await axios.post(`${products_url}/${params.UpateProduct}`, 
  { 
